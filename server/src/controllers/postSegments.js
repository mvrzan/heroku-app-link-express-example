...
const postSegments = async (req, res) => {
  try {
    console.log(`${getCurrentTimestamp()} 🪬 - postSegments - Request received...`);
    ...
    console.log(`${getCurrentTimestamp()} ✅ - postSegments - Segment information successfully provided!`);
    ...
    console.error(`${getCurrentTimestamp()} ❌ - postSegments - Error occurred: ${error.message}`);
